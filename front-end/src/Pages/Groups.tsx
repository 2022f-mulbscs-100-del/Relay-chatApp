import { FiBell, FiBookmark, FiCalendar, FiChevronDown, FiClock, FiFilter, FiMessageCircle, FiMoreVertical, FiPlus, FiSearch, FiStar, FiUsers } from "react-icons/fi";
...
const Groups = () => {
  ...
  const groups = [
    { name: "Design Team", members: 14, activity: "Active now", unread: 3, tag: "Team", pinned: true },
    { name: "Product Sync", members: 22, activity: "5 min ago", unread: 0, tag: "Work" },
    { name: "Marketing Launch", members: 12, activity: "12 min ago", unread: 4, tag: "Work", pinned: true },
    { name: "Community Events", members: 31, activity: "1 hr ago", unread: 0, tag: "Social" },
    { name: "Founders Circle", members: 9, activity: "Yesterday", unread: 0, tag: "Work" },
    { name: "Weekend Hike", members: 8, activity: "2 days ago", unread: 1, tag: "Social" },
  ];
                ...
                {categories.map((category) => (
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-3 py-2 rounded-lg text-left transition ${
                      category.active ? "bg-slate-900 text-white" : "text-slate-700 hover:bg-slate-50"
                    }`}
                  >
            ...
            <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
              ...
              <div className="space-y-2 text-sm text-slate-700">
                {groups
                  ...
                  .map((group) => (
                    <div key={group.name} className="flex items-center justify-between rounded-lg border border-slate-200 px-3 py-2">
                      <div>
