    ...
    return (
        <section className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-6 shadow-sm transition-colors duration-200">
            <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-sm font-semibold text-slate-700 dark:text-slate-300">Notifications</h2>
            </div>
            <div className="space-y-3 text-sm">
                <label className="flex items-center justify-between">
                    <span>Message alerts</span>

                    <span className={`w-10 h-6 rounded-full cursor-pointer ${messageAlertEnabled ? "bg-slate-900 dark:bg-white" : "bg-slate-200 dark:bg-slate-600"} relative`}
                ...
                <label className="flex items-center justify-between">
                    <span>Mentions</span>
                    <span className="w-10 h-6 rounded-full bg-slate-200 dark:bg-slate-600 relative">
