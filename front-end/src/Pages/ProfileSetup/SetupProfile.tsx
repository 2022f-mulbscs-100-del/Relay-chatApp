        ...
        <div className="w-full px-0 py-6">
          <div className="w-full px-20">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-semibold text-slate-900 dark:text-slate-100">Set up your profile</h1>
                <p className="text-sm text-slate-500 dark:text-slate-400">Tell people who you are and what you do</p>
              </div>
              <button 
                className="px-3 py-2 rounded-lg border border-slate-200 dark:border-slate-600 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 transition cursor-pointer" 
                onClick={() => { navigate("/") }}
              >
                Skip for now
              </button>
            ...
            <div className="mt-6 rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-6 shadow-sm transition-colors duration-200">
              <div className="flex flex-col md:flex-row md:items-center gap-6">
                ...
                >
                  <div className="w-full h-full rounded-full bg-slate-100 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 flex items-center justify-center overflow-hidden">
                    {isUploading ? (
                      ...
                      <FiCamera className="text-slate-500 dark:text-slate-400" />
                    )}
                  </div>
                  <button className="absolute -bottom-1 -right-1 w-8 h-8 rounded-full bg-slate-900 dark:bg-white text-white dark:text-slate-900 flex items-center justify-center shadow">
                    <FiPlus className="w-4 h-4 cursor-pointer" />
                  </button>
                </div>
                <div className="flex-1">
                  <p className="text-sm font-medium text-slate-800 dark:text-slate-200">Profile photo</p>
                  ...
                  <div className="mt-3 flex items-center gap-2">
                    <button 
                      type="button"
                      className="px-3 py-2 rounded-lg bg-slate-900 dark:bg-white text-white dark:text-slate-900 text-sm hover:bg-slate-800 dark:hover:bg-slate-100 transition disabled:opacity-50"
                      onClick={()=>{InputRef.current?.click()}}
                    ...
                    <button 
                      type="button"
                      className="px-3 py-2 rounded-lg border border-slate-200 dark:border-slate-600 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 transition disabled:opacity-50"
            ...
            <div className="mt-6 flex items-center justify-between">
              ...
              <button 
                className="cursor-pointer px-4 py-2 rounded-lg bg-slate-900 dark:bg-white text-white dark:text-slate-900 text-sm font-medium hover:bg-slate-800 dark:hover:bg-slate-100 transition"
