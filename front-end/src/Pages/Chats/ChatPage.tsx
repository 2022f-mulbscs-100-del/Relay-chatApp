...
const ChatPage = ({
    ...
    return (
        <div className="relative flex flex-col w-full h-full">
            ...
            <div className="flex-1 overflow-auto customScrollbar bg-slate-50 dark:bg-slate-800 px-3 py-4 sm:px-4 transition-colors duration-200">
            ...
            <form onSubmit={mode === "private" ? SendMessage : SendGroupMessage} className="border-t border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-3 py-3 sm:px-4 transition-colors duration-200">
                <div className="flex items-center gap-2">
                    <input
                        ref={InputRef}
                        className="w-full rounded-lg border border-slate-200 dark:border-slate-600 bg-slate-50 dark:bg-slate-700 px-3 py-2 text-sm outline-none focus:border-slate-400 dark:focus:border-slate-500 text-slate-900 dark:text-slate-100 transition-colors duration-200"
                        type="text"
                    ...
                    <button
                        ...
                        type="button"
                        className="px-3 py-2 cursor-pointer rounded-lg border border-slate-200 dark:border-slate-600 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 transition">
                        <GoPaperclip />
                    </button>
                    <button
                        type="submit"
